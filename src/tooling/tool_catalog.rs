...
fn tool_description(name: &str) -> &'static str {
    match name {
        ...
        "vfx_apply" => {
            "Apply an authoring mutation to a Visual Effect Graph asset (ops: add_block, set_block_setting, add_context, add_operator, add_parameter, link_slots, set_slot_value, unlink_slots, link_flow, set_bounds, add_sticky_note, set_instancing, create_subgraph_asset, create_from_template)"
        }
        "vfx_runtime" => {
