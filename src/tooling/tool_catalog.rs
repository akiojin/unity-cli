...
fn tool_description(name: &str) -> &'static str {
    match name {
        ...
        "vfx_runtime" => {
            "Control a VisualEffect component at runtime via its public API (ops: set_asset, set_float, set_int, set_bool, set_vector2/3/4, send_event, set_initial_event_name, reinit, get_state)"
        }
        "vfx_settings" => {
